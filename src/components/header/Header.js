...
function Header() {
    ...
    window.addEventListener("scroll", function () {
        ...
        //when the scroll is heigher than 200 viewport height , add the srollheader class to a tag with the header tag
  ...
  return (
    <header className='header'>
        <nav className='nav container'>
            <a href="index.html" className='nav__logo'>Anitha Kaladharn</a>
            ...
            <ul className='nav__list grid'>
                ...
                <li className={Toggle ? "nav__item show-menu" : "nav__menu"}>
